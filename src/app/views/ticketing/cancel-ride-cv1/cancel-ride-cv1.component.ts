...
@Component({
    standalone: true,
    selector: 'cancel-ride-cv1',
    imports: [CommonModule, ReactiveFormsModule, MatIconModule, RouterModule, ConfirmDialogComponent],
    templateUrl: './cancel-ride-cv1.component.html',
    styleUrls: ['./cancel-ride-cv1.component.scss'],
})
export class CancelRideCV1Component implements OnInit {
    step: number;
